...
public class RecordWeightHeight extends Fragment {
    ...
    final double[] weight50 = {3.3,4.5,5.6,6.4,7,7.5,7.9,8.3,8.6,8.9,9.2,9.4,9.6,9.9,10.1,10.3,10.5,10.7,
            10.9,11.1,11.3,11.5,11.8,12,12.2};
    final double[] weight75 = {3.7,4.9,6,6.9,7.6,8.1,8.5,8.9,9.3,9.6,9.9,10.1,10.4,10.6,10.9,11.1,11.3,
            11.6,11.8,12,12.2,12.5,12.7,12.9,13.1};
    final double[] weight95 = {4.2,5.5,6.8,7.7,8.4,9,9.5,9.9,10.3,10.6,10.9,11.2,11.5,11.8,12.1,12.3,
            12.6,12.9,13.1,13.4,13.6,13.9,14.2,14.4,14.7};

    final double[] height5 = {46.8,51.5,55.1,58.1,60.5,62.4,64.1,65.6,67,68.3,69.5,70.7,71.8,72.9,74,75,
            76,76.9,77.8,78.7,79.6,80.4,81.2,82,82.8};
    final double[] height25 = {48.6,53.4,57.1,60.1,62.5,64.5,66.2,67.7,69.1,70.5,71.7,73,74.1,75.3,76.4,
            77.4,78.5,79.5,80.4,81.4,82.3,83.2,84.1,84.9,85.8};
    final double[] height50 = {49.9,54.7,58.4,61.4,63.9,65.9,67.6,69.2,70.6,72,73.3,74.5,75.7,76.9,
            78,79.1,80.2,81.2,82.3,83.2,84.2,85.1,86,86.9,87.8};
    final double[] height75 = {51.2,56,59.8,62.8,65.3,67.3,69.1,70.6,72.1,73.5,74.8,76.1,77.4,78.6,79.7,
            80.9,82,83,84.1,85.1,86.1,87.1,88,89,89.9};
    final double[] height95 = {53,57.9,61.7,64.8,67.3,69.4,71.1,72.7,74.2,75.7,77,78.4,79.7,80.9,82.1,
